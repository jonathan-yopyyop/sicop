...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["sicop.maloka.org"])
...
STORAGES = {
    "default": {
        "BACKEND": "sicop.utils.storages.MediaAzureStorage",
    },
    "staticfiles": {
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="SICOP <noreply@sicop.maloka.org>",
)
