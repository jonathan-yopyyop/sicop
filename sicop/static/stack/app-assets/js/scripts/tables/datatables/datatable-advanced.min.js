$(document).ready((function () {
    ...
    $(".setting-defaults").dataTable($.extend(!0, {}, {
        ...
        createdRow: function (t, e, a) {
            1 * e[5].replace(/[\$,]/g, "") > 15e4 && $("td", t).eq(5).addClass("highlight")
        }
    });
    var e = $(".row-grouping").DataTable({
        ...
        drawCallback: function (t) {
            ...
            e.column(2, {
                ...
                o !== t && ($(a).eq(e).before('<tr class="group"><td colspan="5">' + t + "</td></tr>"), o = t)
            }))
        }
    });
    $(".row-grouping tbody").on("click", "tr.group", (function () {
        ...
        footerCallback: function (t, e, a, o, r) {
            ...
            total = n.column(4).data().reduce((function (t, e) {
                return l(t) + l(e)
    ...
    $(".file-export").DataTable({
        dom: '<"pb-2 d-flex justify-content-between align-items-center"<"btn-group"B><"form-inline"l>f>rtip', // Agrega el selector de longitud a la izquierda del paginador
        ...
        columnDefs: [
            { type: 'num', targets: 0 } // Define la primera columna como tipo numérico
        ],
